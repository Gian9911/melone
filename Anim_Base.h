//
// Created by gianluca on 03/09/19.
//

#ifndef MELONE_ANIM_BASE_H
#define MELONE_ANIM_BASE_H


#include <string>

class SpriteSheet;//la classe include SpriteSheet e SpriteSheet include questa classe
...
protected:
    ...
    Frame m_frameEnd;
    Frame m_frameRow;
    int m_frameActionStart;// azione specifica inizia
    int m_frameActionEnd;//azione conclusa
    float m_frameTime;
    float m_elapsedTime;
    bool m_loop;
    bool m_playing;
