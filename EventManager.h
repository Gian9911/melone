//
// Created by gianluca on 03/08/19.
//
...
#include <SFML/Graphics/RenderWindow.hpp>
    ...
    enum class EventType {
        ...
        Keyboard = sf::Event::Count + 1, Mouse, Joistick
    };
 ...
 //non so se va aggiuna anche la struct del Callback
 ...
 public:
     ...
     void Update();
     sf::Vector2i GetMousePose(sf::RenderWindow* l_wind = nullptr){
